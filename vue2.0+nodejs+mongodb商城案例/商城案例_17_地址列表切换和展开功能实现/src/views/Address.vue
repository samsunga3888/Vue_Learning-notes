        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
									<!--01.通过vue计算属性，实现地址列表截取显示。-->
									<!--03_1.点击触发当前地址index的值赋给checkIndex，进而触发check样式的改变。-->
              ...
              <div class="shipping-addr-more">
								<!--02.调用expand方法，用户点击页面more后，显示全部地址。-->
								<!--02_2.控制展开关闭箭头显示。-->
      ...
      data(){
          return{
			...
			computed: {
				//01_1.编写计算属性
				addressListFilter() {
					return this.addressList.slice(0,this.limit);//slice方法返回全新数据，不会修改addreList数组
				},
