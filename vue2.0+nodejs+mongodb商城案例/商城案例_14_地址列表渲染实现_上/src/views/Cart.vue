          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
								<!--04_2.调用toggleCheckAll方法-->
                <a href="javascipt:;" @click="toggleCheckAll">
									<!--04_1.调用checkAllFlag方法-->
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
								<!--03_1.通过checkedCount控制css样式是否显示-->
								<!--03_2.通过checkOut方法控制页面checkout按钮是否可点击-->
    ...
    export default{
        data(){
            return{
				...
				//01_2.通过Vue过滤器功能调用currency插件
				filters:{
					currency:currency
				},
				computed: {
					//02.编写计算购物车内所有物品价格总和函数
					totalPrice(){
					  let money = 0;
